...
This command will install and execute [create-vue](https://github.com/AliMales/NoteBookcreate-vue), the official Vue project scaffolding tool.
...
If you are looking for a lighter-weight alternative for no-build-step usage, check out [petite-vue](https://github.com/AliMales/NoteBookpetite-vue).
...
The Vue team maintains [eslint-plugin-vue](https://github.com/AliMales/NoteBookeslint-plugin-vue), an [ESLint](https://eslint.org/) plugin that supports SFC-specific linting rules.
...
- [Docs](https://github.com/AliMales/NoteBookcore/tree/main/packages/compiler-sfc)
