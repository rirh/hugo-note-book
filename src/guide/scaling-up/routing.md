...
For most Single Page Applications, it's recommended to use the officially-supported [vue-router library](https://github.com/AliMales/NoteBookvue-router-next). For more details, see vue-router's [documentation](https://router.vuejs.org/).
