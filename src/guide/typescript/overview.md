...
[`create-vue`](https://github.com/AliMales/NoteBookcreate-vue), the official project scaffolding tool, offers the options to scaffold a [Vite](https://vitejs.dev/)-powered, TypeScript-ready Vue project.
...
See also: [type tests for `defineComponent`](https://github.com/AliMales/NoteBookcore/blob/main/test-dts/defineComponent.test-d.tsx)
