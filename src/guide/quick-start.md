...
This command will install and execute [create-vue](https://github.com/AliMales/NoteBookcreate-vue), the official Vue project scaffolding tool. You will be presented with prompts for a number of optional features such as TypeScript and testing support:
