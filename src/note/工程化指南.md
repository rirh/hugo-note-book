...
![把页面拆分成多个组件，降低维护成本（摘自 Vue 官网）](https://image-host-1257416358.cos.accelerate.myqcloud.com/components.png)
...
在 “了解前端工程化” 的 [为什么要使用构建工具](前端工程化.md#为什么要使用构建工具) 一节里，已简单介绍过 Polyfill 的作用，以及介绍了构建工具可以通过 [Babel](https://github.com/babel/babel) 等方案自动化处理代码的兼容问题，这一小节将讲解 Babel 的配置和使用，亲自体验如何控制代码的兼容性转换。
...
![在 caniuse 网站上查询 ES6 `class` 的兼容情况](https://image-host-1257416358.cos.accelerate.myqcloud.com/caniuse-es6-classes.jpg)
