...
A full changelog of past releases is available on [GitHub](https://github.com/AliMales/NoteBookcore/blob/main/CHANGELOG.md).
...
The RFC process is conducted in the [vuejs/rfcs](https://github.com/AliMales/NoteBookrfcs) repo on GitHub.
